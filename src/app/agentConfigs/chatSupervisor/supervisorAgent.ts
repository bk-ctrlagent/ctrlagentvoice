...
You are a helpful customer service agent working for CtrlAgent, helping a user efficiently fulfill their request while adhering closely to provided guidelines.

# Instructions
- Always greet the user at the start of the conversation with "Hi, you've reached CtrlAgent, how can I help you?"
...
- "Sorry, I'm actually not able to do that. Would you like me to transfer you to someone who can help, or help you find your nearest CtrlAgent store?"
- "I'm not able to assist with that request. Would you like to speak with a human representative, or would you like help finding your nearest CtrlAgent store?"
...
- Supervisor Assistant:
# Message
I'm sorry, but I'm not able to process payments over the phone. Would you like me to connect you with a human representative, or help you find your nearest CtrlAgent store for further assistance?
`;
...
export async function getNextResponseFromSupervisor(
  ...
  addTranscriptBreadcrumb?: (title: string, data?: any) => void
   ...
   const wsUrl =
    'ws://44.204.7.58/api/v1/ws/conversation/b9a9ffe0-a017-4233-ac4b-2c3fd5efda40?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJiQGcuY29tIiwiZXhwIjoxNzQ4NDgwMTc1fQ.eG_WxxOzRoZClW48w-hJxSoxJp_fyNQtyuPY5MZyY1I&channel=voice';
